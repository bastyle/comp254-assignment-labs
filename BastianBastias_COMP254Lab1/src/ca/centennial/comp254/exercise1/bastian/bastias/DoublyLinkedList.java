...
//	  System.out.println(list.first());
		...
		list.trailer.getPrev().setNext(list2.header.getNext());
		list2.header.setPrev(list.trailer.getPrev());
//	  list.trailer.setPrev(list2.trailer.getPrev());
		...
		// swap regular case 4 reference changes
		System.out.println("----");
		System.out.println(list);
		list.swap("BOS", "MAN");
		System.out.println(list);
	...
	private void swap(E element1, E element2) {
		Node<E> node1 = getNode(element1);
		Node<E> node2 = getNode(element2);
		System.out.println(node1.getElement());
		System.out.println(node2.getElement());
		Node<E> node1Prev = node1.prev;
...
//		node1.setNext(node2Next);
	...
	private Node<E> getNode(E element) {
		Node<E> walk = header.getNext();
		while (walk != trailer) {
			if (element.equals(walk.getElement())) {
				return walk;
			}
			walk = walk.getNext();
		}
